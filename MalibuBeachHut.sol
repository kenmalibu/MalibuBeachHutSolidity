...
contract MalibuBeachHut is ERC1155Supply, Ownable, ReentrancyGuard {
    ...
    uint256 public currentUlockableId;
    bool public paused;
        ...
        nonReentrant 
    {
        ...
        checkMintRequirements(currentUlockableId, unlockablePrice);

        coin.transferFrom(_msgSender(), address(this), unlockablePrice);
        _mint(_msgSender(), currentUlockableId, maxMintQty, "");
    }
    ...
    function setCurrentUlockableId(uint256 id) public onlyOwner {
        currentUlockableId = id;
    }
